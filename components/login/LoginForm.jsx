...
const LoginForm = ({ setLogin }) => {
	...
	const fetchData = async () => {
		try {
			...
			const response = await fetch(`https://mamosh-backend.vercel.app/api/addcart/getcart`, {
				method: 'POST',
				headers: {
	...
	let loginUser = async () => {
		...
		if (validate()) {
			try {
				const response = await fetch(`https://mamosh-backend.vercel.app/api/user/signin`, {
					method: 'POST',
					headers: {
						'Content-type': 'Application/json'
					},
