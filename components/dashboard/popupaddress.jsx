...
const popupcard = ({ open, Setopen, userData, setUserData, address, Setaddress,email}) => {
      ...
      >
        <div className="add-payment-main">
          ...
          <div className="down-menu">
            <div>
                <p id="back" onClick={()=>{Setopen(false)}}><IoIosArrowBack style={{fontSize:'12px', position:'relative', top:'-1px'}} /> Back</p>
            </div>
            <div className="f-2">
                <div className="fr-save" onClick={addaddress}>Save</div>
            </div>
          </div>
        </div>
      </OutsideClickHandler>
